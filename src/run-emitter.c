...
int copy_event(yaml_event_t *event_to, yaml_event_t *event_from)
{
    switch (event_from->type)
    {
        case YAML_STREAM_START_EVENT:
            printf("SSSS-[YAML_STREAM_START_EVENT]\n");
            return yaml_stream_start_event_initialize(event_to,
                    event_from->data.stream_start.encoding);

        case YAML_STREAM_END_EVENT:
            printf("SSSS-[YAML_STREAM_END_EVENT]\n");
            return yaml_stream_end_event_initialize(event_to);

        case YAML_DOCUMENT_START_EVENT:
            printf("SSSS-[YAML_DOCUMENT_START_EVENT]\n");
            printf("SSSS-参数1[%d-%d]参数2[%d-%d]参数3[%d-%d]参数4[%d]\n",
        ...
        case YAML_SEQUENCE_START_EVENT:
            printf("SSSS-[YAML_SEQUENCE_START_EVENT]\n");
            printf("SSSS-参数1anchor[%d]参数2tag[%d]参数3implicit[%d]style[%d]\n",
        ...
        case YAML_SEQUENCE_END_EVENT:
            printf("SSSS-[YAML_SEQUENCE_END_EVENT]\n");
            return yaml_sequence_end_event_initialize(event_to);

        case YAML_MAPPING_START_EVENT:
            printf("SSSS-[YAML_MAPPING_START_EVENT]\n");
            printf("SSSS-参数1anchor[%d]参数2tag[%d]参数3implicit[%d]style[%d]\n",
        ...
        case YAML_MAPPING_END_EVENT:
            printf("SSSS-[YAML_MAPPING_END_EVENT]\n");
